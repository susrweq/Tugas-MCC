...
<head>
     ...
     <title>Aplikasi Muria Skil Developer</title>
</head>

<body style="background-color:hsl(175, 52.00%, 70.60%);">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg" style="background-color: #add8e6;">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Skil Developer Muria Computer Club</a>
     ...
     <div class="container-fluid">
          <div class="row bg-primary text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                         Pembuat:
                         Nafar Ja'far Ashidiqi 202353135
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.data_siswa', {
          duration: 1,
          delay: 0.6,
          text: 'Daftar Mentoring Skill Web Developer :)'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
